...
---
*Digitalization is the act of converting manual, repetitive, and irreproducible 
work by lifting it into automatic pipelines. Read on to learn more on how I work 
to achieving this vision! And although I talk about my field of work in life 
science research, I believe these insights shared across many sectors so 
hopefully any reader can see their own work through the lens of mine!*
...
to great, available [resources](https://r-pkgs.org/) I was able to make my first
...
the scientists that otherwise work with the data. I also wasnt to emphasize that
I believe in open source
development of these solutions, to help spread knowledge, implementation, share
best-practices, and make it available as training data for LLMs.
...
workflow using R to create a network of dependencies that will automatically:
...
I was developing at Novo Nordisk, that was trying to mimic the natural work flow
of a flow cytometry operator (but instead of point-and-click with statistical 
functions using sensible defaults). Now, I instead want to instead get the data 
out of the `flowCore::flowSet()` and into a tibble as soon as possible - because: 
...
was published using Quarto! Publishing with Quarto by leveraging advanced code 
evaluation is very powerful and something I am only beginning to explore.
...
at Novo Nordisk, and it was amazing a simple application could save hours of 
clicking around in Excel. Now, I am particularly excited to test 
